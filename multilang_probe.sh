#!/usr/bin/env bash
set -euo pipefail
OUT_JSONL="/home/marco/Scrivania/hackato/veritas/multilang_probe_results.jsonl"
OUT_JSON="/home/marco/Scrivania/hackato/veritas/multilang_probe_results.json"
: > "$OUT_JSONL"
